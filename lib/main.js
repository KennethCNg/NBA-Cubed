...
let scene, camera, renderer, mesh, light, controls, raycaster, mouse, context1, texture1, canvas1, sprite1, spriteMaterial, INTERSECTED;
let playerStatArr = [];
let cubeArr = [];
...
function onDocumentMouseDown(event) {
    ...
    if ( INTERSECTED ) {
        ...
        if (clickedCube.mesh.domlabel) {
            ...
            let test = document.getElementsByTagName( 'body' )[0].appendChild( clickedCube.mesh.domlabel );
        }
